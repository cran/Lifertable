...
#'
#' @param x A lifertableCIJackknife object.
#' @inheritParams base::as.data.frame
#'
#' @return \code{as.data.frame.lifertableCIJackknife} returns a data frame.
#' @export
#'
#' @examples
...
#'
as.data.frame.lifertableCIJackknife <- function (x, row.names = NULL, ...) {
  if(is.list(x)) {
    if ("Ro" %in% names(x)) {
